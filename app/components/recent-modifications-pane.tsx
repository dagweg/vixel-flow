...
import { ImageState, setImageSelectedAll } from "@/lib/redux/slices/imageSlice";
        ...
        {isSelectMode && (
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56">
              <DropdownMenuCheckboxItem onClick={() => setIsSelectMode(false)}>
                Clear selection
              </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem
              ...
              <DropdownMenuCheckboxItem
                onClick={() => handleDeleteSelected(dispatch)}
              >
                Delete Selected
              </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem
                onClick={() => dispatch(setImageSelectedAll(true))}
              >
                Select All
              </DropdownMenuCheckboxItem>
            </DropdownMenuContent>
